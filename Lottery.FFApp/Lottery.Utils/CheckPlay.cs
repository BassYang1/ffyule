        ...
        public static int Check(string LotteryNumber, string CheckNumber, string Pos, string sType)
        {
            ...
            if (LotteryNumber != "" && CheckNumber != "" && sType != "")
            {
                ...
                switch (sType)
                {
                    ...
                    case "P_DX_S":
                    case "P_DX_G":
                        return CheckSSC_DXDS.P_2DX(LotteryNumber, CheckNumber, sType.Replace("P_DX_", ""));
                    case "P_DS_W": //时时彩，猜单双
                    case "P_DS_Q":
                    case "P_DS_B":
                    case "P_DS_S":
                    case "P_DS_G":
                        return CheckSSC_DXDS.P_2DS(LotteryNumber, CheckNumber, sType.Replace("P_DS_", ""));
                    case "P11_RXTD2":
                    case "P11_RXTD3":
                    case "P11_RXTD4":
                    case "P11_RXTD5":
                    ...
                    case "P11_RXTD7":
                    case "P11_RXTD8":
                        return Check11X5_RXTD.RXTD(LotteryNumber, CheckNumber, sType.Replace("P11_RXTD", ""));
                    case "K_3HZ3":
                    case "K_3HZ4":
                    case "K_3HZ5":
                    case "K_3HZ6":
                    ...
                    case "PK10_DXFour":
                        return CheckPK10_DXDS.PK10_DX(LotteryNumber, CheckNumber, 4);
                    case "PK10_DXFive":
                        return CheckPK10_DXDS.PK10_DX(LotteryNumber, CheckNumber, 5);
                    case "PK10_DXSix":
                        return CheckPK10_DXDS.PK10_DX(LotteryNumber, CheckNumber, 6);
                    case "PK10_DXSeven":
                        return CheckPK10_DXDS.PK10_DX(LotteryNumber, CheckNumber, 7);
                    case "PK10_DXEight":
                        return CheckPK10_DXDS.PK10_DX(LotteryNumber, CheckNumber, 8);
                    case "PK10_DXNine":
                        return CheckPK10_DXDS.PK10_DX(LotteryNumber, CheckNumber, 9);
                    case "PK10_DXTen":
                        return CheckPK10_DXDS.PK10_DX(LotteryNumber, CheckNumber, 10);
                    case "PK10_DSOne":
                    ...
                    case "PK10_DSFour":
                        return CheckPK10_DXDS.PK10_DS(LotteryNumber, CheckNumber, 4);
                    case "PK10_DSFive":
                        return CheckPK10_DXDS.PK10_DS(LotteryNumber, CheckNumber, 5);
                    case "PK10_DSSix":
                        return CheckPK10_DXDS.PK10_DS(LotteryNumber, CheckNumber, 6);
                    case "PK10_DSSeven":
                        return CheckPK10_DXDS.PK10_DS(LotteryNumber, CheckNumber, 7);
                    case "PK10_DSEight":
                        return CheckPK10_DXDS.PK10_DS(LotteryNumber, CheckNumber, 8);
                    case "PK10_DSNine":
                        return CheckPK10_DXDS.PK10_DS(LotteryNumber, CheckNumber, 9);
                    case "PK10_DSTen":
                        return CheckPK10_DXDS.PK10_DS(LotteryNumber, CheckNumber, 10);
                    case "wj1":
