...
namespace Lottery.Collect
{
	public class TimeData
    {
		...
		{
			TimeData.timerCqSsc_Elapsed(null, null);
		...
		{
			TimeData.timerNy30_Elapsed(null, null);
		...
		{
			TimeData.timerXjp30_Elapsed(null, null);
		...
		{
			TimeData.timerTw60_Elapsed(null, null);
		...
		{
			TimeData.timerSe60_Elapsed(null, null);
