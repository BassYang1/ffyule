  ...
  public partial class ajax : UserCenterSession
  {
    ...
    private void ajaxLotteryTime()
    {
        ...
        else if (ltId == "4006")
        {
            ...
            {
                newValue2 = curDateTime.Year + "-" + dataRowArray1[0]["Sn"].ToString(); //下一期开奖期号
                dateTime1 = Convert.ToDateTime(dataRowArray1[0]["Time"].ToString()); //下一期开奖时间   
            }
            ...
            {
                newValue1 = curDateTime.Year + "-" + dataRowArray2[0]["Sn"].ToString(); //当前期开奖期号
                str2 = dataRowArray2[0]["Sn"].ToString(); //当前期开奖时间
            }
