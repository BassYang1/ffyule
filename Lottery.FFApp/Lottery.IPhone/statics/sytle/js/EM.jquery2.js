...
function CreateNumber() {
    ...
    switch (PlayCode) {
        ...
        case "P_DS_G":
            ...
            var str = "<ul class='lottery-set J_LotterySet'>";
            str += "<li class='numbers'>";
            str += "<span class='lottery-pos'>" + wz1 + "</span>";
            str += "<div class='lottery-balls J_LotteryBallHolder'>";
    ...
    if (td11x5) {
        ...
        var str = "<ul class='lottery-set J_LotterySet'>";
        str += "<li class='numbers'>";
        str += "<span class='lottery-pos'>胆码</span>";
        str += "<div class='lottery-balls J_LotteryBallHolder'>";
        for (var j = 0; j < 11; j++) {
            var numVal = j + 1
            if (numVal < 10)
                str += "<span class='ball J_Ball' number='0" + numVal + "'>0" + numVal + "</span>";
            else
                str += "<span class='ball J_Ball' number='" + numVal + "'>" + numVal + "</span>";
        }
        str += "</div></li>";

        str += "<li class='numbers'>";
        str += "<span class='lottery-pos'>拖码</span>";
        str += "<div class='lottery-balls J_LotteryBallHolder'>";
        for (var j = 0; j < 11; j++) {
            var numVal = j + 1
            if (numVal < 10)
        ...
        var str = "<ul class='lottery-set J_LotterySet'>";
        str += "<li class='numbers'>";
        str += "<span class='lottery-pos'>" + PlayName + "</span>";
        str += "<div class='lottery-balls J_LotteryBallHolder'>";
