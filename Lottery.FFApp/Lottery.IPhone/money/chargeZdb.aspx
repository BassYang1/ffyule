    ...
    <script type="text/javascript">
        ...
        function submitPay() {
            ...
            if (bank && userId && userId != "0") {
                url = getHost() + "/pay/zdbbill/pay.aspx?bank=" + bank + "&setCode=suibipay&amount=" + uMoney + "&userId=" + userId + "&orderId=" + orderId + "&clienttime=" + Math.random();
                ...
                <div class="form-item">
                    ...
                    <div class="item-content">
                        <div class="item-content-text">
                            <label><input type="radio" value="aliapi_h5api" title="支付宝移动支付" class="radio bank" name="bank" checked/>支付宝</label>
