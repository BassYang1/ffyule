    ...
    <script type="text/javascript">
        ...
        function ajaxList() {
            ...
            $.ajax({
                ...
                url: "/ajax/ajaxBank.aspx?oper=ajaxGetChargeSetList&id=1074",
        ...
        function submitPay() {
            ...
            var uMoney = $("#txtPayMoney").val();
            if (orderId && user.id && user.id != "0") {
                url = getHost() + "/pay/suibipay/pay.aspx?bank=" + bank + "&setCode=suibipay&amount=" + uMoney + "&userId=" + user.id + "&orderId=" + orderId + "&clienttime=" + Math.random();
                ...
                <div class="form-item">
                    ...
                    <div class="item-content">
                        <div class="item-content-text">
                            <label><input type="radio" value="ZFB" title="支付宝即时到账" class="radio" name="bank" checked/>支付宝</label>
                            <label><input type="radio" value="WX" title="微信扫码支付" class="radio" name="bank"/>微信</label>
