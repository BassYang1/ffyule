...
{
	public class newsinfo : UserCenterSession
	{
		protected void Page_Load(object sender, EventArgs e)
		{
			...
			if (!this.Page.IsPostBack)
			{
				...
				string sql = SqlHelp.GetSql0("Substring(Convert(varchar(10),STime,120),6,2) as tmonth,Substring(Convert(varchar(10),STime,120),9,2) as tday,*", "Sys_News", "STime", 999, 1, "desc", text);
				this.doh.Reset();
				this.doh.SqlCmd = sql;
