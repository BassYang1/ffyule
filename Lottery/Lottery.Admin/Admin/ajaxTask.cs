...
{
	public class ajaxTask : AdminCenter
	{
		...
		private void ajaxGetList()
		{
			...
			string sql = SqlHelp.GetSql0("*", "Sys_TaskSet", "Sort", pageSize, num, "asc", text);
			this.doh.Reset();
			this.doh.SqlCmd = sql;
		...
		private void ajaxDel()
		{
			...
			int num = this.doh.Delete("Sys_TaskSet");
			if (num > 0)
			{
