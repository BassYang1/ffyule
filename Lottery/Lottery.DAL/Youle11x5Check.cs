...
namespace Lottery.DAL
{
	public static class Youle11x5Check
	{
		public static void RunOfIssueNum(int LotteryId, string IssueNum)
		{
			...
			doWord.BeginInvoke(LotteryId, IssueNum, new AsyncCallback(Youle11x5Check.CallBack), doWord);
		}

		public static void CallBack(IAsyncResult r)
		{
			Youle11x5Check.DoWord arg_0B_0 = (Youle11x5Check.DoWord)r.AsyncState;
		}
