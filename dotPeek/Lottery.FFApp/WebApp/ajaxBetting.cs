  ...
  public class ajaxBetting : UserCenterSession
  {
    ...
    private void ajaxLotteryTime23()
    {
      ...
      if (dataTable2.Rows.Count > 0)
      {
        ...
        string newValue4 = dataTable2.Rows.Count > 0 ? string.Concat((object) Decimal.op_Increment(Convert.ToDecimal(dataTable2.Rows[0]["title"].ToString()))) : DateTime.Now.ToString("yyyyMMdd") + "00001";
