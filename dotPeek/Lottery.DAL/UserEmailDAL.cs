...
namespace Lottery.DAL
{
  public class UserEmailDAL : ComData
  {
    ...
    public int Save(string SendId, string ReceiveId, string Title, string Contents)
    {
      ...
      {
        dbOperHandler.Reset();
        dbOperHandler.AddFieldItem(nameof (SendId), (object) SendId);
        dbOperHandler.AddFieldItem(nameof (ReceiveId), (object) ReceiveId);
        dbOperHandler.AddFieldItem(nameof (Title), (object) Title);
        dbOperHandler.AddFieldItem(nameof (Contents), (object) Contents);
