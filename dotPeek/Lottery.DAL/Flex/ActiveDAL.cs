  ...
  public class ActiveDAL : ComData
  {
    ...
    public string SaveHbActive(string UserId, string ActiveType, string ActiveName, Decimal InMoney, string Remark)
    {
      ...
      using (DbOperHandler dbOperHandler = new ComData().Doh())
      {
        ...
        dbOperHandler.AddFieldItem(nameof (ActiveType), (object) ActiveType);
        dbOperHandler.AddFieldItem(nameof (ActiveName), (object) ActiveName);
        dbOperHandler.AddFieldItem(nameof (InMoney), (object) InMoney);
        dbOperHandler.AddFieldItem(nameof (Remark), (object) Remark);
