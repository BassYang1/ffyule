...
namespace Lottery.Utils
{
  ...
  {
    public static string ApiUid = XmlCOM.ReadConfig("~/statics/config/sms", nameof (ApiUid));
    public static string ApiKey = XmlCOM.ReadConfig("~/statics/config/sms", nameof (ApiKey));
